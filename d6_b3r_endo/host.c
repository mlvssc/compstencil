   ...
   while(nn>0)
   {
        ...
        for (blk_i=0;blk_i<n_div;blk_i++)
	{
		...
		cudaMemcpyAsync(buf_A[si]+d_start, A1+h_start, trans_len*sizeof(SB_TYPE), cudaMemcpyHostToDevice, pipes[si]);
	     ...
	     {
        	#define __c0 c0
        	AN5D_TYPE __c1Len = buf_zlen - 3 - 3;
        	AN5D_TYPE __c1Pad = (3);

        	#define __c1 c1
                AN5D_TYPE __c2Len = (dimsize - 3 - 3);
        	AN5D_TYPE __c2Pad = (3);
        	#define __c2 c2
        	AN5D_TYPE __c3Len = (dimsize - 3 - 3);
        	AN5D_TYPE __c3Pad = (3);
        	#define __c3 c3
        	AN5D_TYPE __halo1 = 3;
        	AN5D_TYPE __halo2 = 3;
        	...
        	AN5D_TYPE __side2Len = 10;
        	AN5D_TYPE __side3Len = 26;
		...
		for (c0 = 0; c0 < tb_tps; c0 += 1)
			...
			//printf("%d %d\n",n_zblk * ((__c2Len + __side2Len - 1) / __side2Len) * ((__c3Len + __side3Len - 1) / __side3Len),__blockSize);
